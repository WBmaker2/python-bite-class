...
export const chapter4 = chapter(4, '첫걸음', [
  ...
  makeLesson(4, 3, '소스 파일과 실행 순서', '소스는 사람이 읽는 프로그램 글이며 보통 위에서 아래 순서로 실행됩니다.', 'challenge', 'print("첫 번째")\nprint("두 번째")\nprint("세 번째")', '첫 번째\n두 번째\n세 번째', { prompt: '순서가 드러나는 네 번째 줄을 추가하세요.', hint: 'print("네 번째")처럼 적어 보세요.', checks: [{ mode: 'appended', value: '', feedback: '실행 순서를 코드로 표현했어요.' }] }),
  ...
  makeLesson(4, 5, '첫걸음 확인 실습', '세 줄 인사 프로그램으로 지금까지 배운 실행 흐름을 묶어 봅니다.', 'challenge', 'print("안녕하세요!")\nprint("저는 파이썬 새내기예요.")\nprint("오늘도 한 줄씩!")', '안녕하세요!\n저는 파이썬 새내기예요.\n오늘도 한 줄씩!', { prompt: '세 줄 자기소개를 나만의 말로 바꿔 보세요.', hint: 'print를 지우지 말고 따옴표 안을 고쳐요.', checks: [{ mode: 'changed', value: '', feedback: '나만의 자기소개 프로그램을 완성했어요.' }] }),
]);
