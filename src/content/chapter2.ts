...
export const chapter2 = chapter(2, '파이썬 소개', [
  ...
  makeLesson(2, 4, '소개 확인 실습', '파이썬이 좋은 이유를 짧은 문장으로 출력하며 첫 장을 정리합니다.', 'challenge', 'reason = "쉽게 읽고 바로 고칠 수 있어서"\nprint("나는 파이썬을", reason, "좋아해요.")', '나는 파이썬을 쉽게 읽고 바로 고칠 수 있어서 좋아해요.', { prompt: '내가 파이썬을 배우는 이유를 출력하세요.', hint: 'reason 변수의 따옴표 안을 바꾸면 됩니다.', checks: [{ mode: 'contains', value: '파이썬', feedback: '파이썬을 배우는 이유를 표현했어요.' }, { mode: 'changed', value: '', feedback: '나만의 이유로 문장을 바꿨어요.' }] }),
]);
