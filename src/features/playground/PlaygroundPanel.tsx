...
export function PlaygroundPanel({ lesson, savedCode, onCodeChange, onPracticeComplete }: Props) {
  ...
  if (!lesson.starterCode) return <section className="playground-panel practice-placeholder" aria-label="코드 실습 안내"><span className="chapter-kicker">먼저 읽기</span><h2>읽기 단계</h2><p>가운데 설명을 읽고 핵심을 정리하면 다음 소단원이 열립니다. 다음 실행 단계에서 코드를 직접 다뤄 볼게요.</p></section>;
