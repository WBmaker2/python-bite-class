...
interface Props { lesson: Lesson; savedCode?: string; onCodeChange: (code: string) => void; }

export function PlaygroundPanel({ lesson, savedCode, onCodeChange }: Props) {
