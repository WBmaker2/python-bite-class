...
중학생이 파이썬의 기초 문법을 짧은 설명과 바로 실행해 보는 코드 실험으로 익히는 교육용 웹 앱입니다. 『A Byte of Python』의 2장 「파이썬 소개」부터 11장 「실생활 문제 해결」까지를 학습 흐름으로 재구성했습니다.
